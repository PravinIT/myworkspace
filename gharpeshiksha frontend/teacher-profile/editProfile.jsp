...
<%TutorDetail tut=ofy().load().type(TutorDetail.class).id(9990461910L).now();%>
	...
	<div class="row ">
		...
		<div class=" col-xs-12 col-sm-12 col-md-12" style="padding-right: 25px;">
			...
			<div class="container col8-back-colr" style="margin-bottom: 40px;">
			<div >
           ...
           <div class="row" style="margin-bottom:9px;">
           	<div class="col-sm-6 col-sm-offset-2 col-md-6 col-md-offset-2"><h3>
           		<b style="font-weight: 480;">Basic Information:</b></h3></div>
          ...
          <div class="form-group">
          	<div class="col-sm-3 col-md-3" style="margin-top:6px;"><b style="font-weight: 550;">Full Name</b></div>
          	

          	<div class="col-sm-9 col-md-9">
          		<input type="text" value="<%=tut.getName()%>" style="width: 100%; border: 1px solid #D5D5D5; border-radius: 0px; padding: 6px 6px 7px; cursor: text; margin: 5px;" >
          ...
          <div class="row">
            <div class="form-group">
          	<div class="col-sm-3 col-md-3" > <b style="font-weight: 550;">Alternate No.</b></div>
          	

          	<div class="col-sm-9 col-md-9">
          		<input type="tel" value="<%=tut.getAlt_contact()%> " style="width: 100%; border: 1px solid #D5D5D5; border-radius: 0px; padding: 6px 6px 7px; cursor: text; margin: 5px;" >
          ...
          <div class="row">
              <div class="form-group">
          	<div class="col-sm-3 col-md-3" > <b style="font-weight: 550;">Permanent Address</b></div>
          	

          	<div class="col-sm-9 col-md-9">
          		<input type="text" value="<%=tut.getPermanent_add()%>" style="width: 100%; border: 1px solid #D5D5D5; border-radius: 0px; padding: 6px 6px 7px; cursor: text; margin: 5px;" >
          ...
          <div class="row">
              <div class="form-group">
          	<div class="col-sm-3 col-md-3"> <b style="font-weight: 550;">Current Address</b></div>
          	

          	<div class="col-sm-9 col-md-9">
          		<input type="text" value="<%=tut.getCurrent_add()%>" style="width: 100%; border: 1px solid #D5D5D5; border-radius: 0px; padding: 6px 6px 7px; cursor: text; margin: 5px;" >
          ...
          <div class="col-md-8 col-md-offset-2">
          	<input type="checkbox" id="tel" name="billingtoo" onclick="FillingBilling(this.form)">
          	<b style="font-weight: 550;"> Same as above</b>
          </div> </div>
           ...
           <div class="row" style="margin-top:6px; margin-bottom:6px;">
           	<div class="col-sm-6 col-sm-offset-2 col-md-6 col-md-offset-2"><h3>
           		<b style="font-weight: 480;">Teaching Information:</b></h3></div>
           ...
           <div class="row" style="margin-top: 10px;"><div class="form-group">
          	<div class="col-sm-3 col-md-3"><b style="font-weight: 550;">Qualification</b></div>
          	

          	<div class="col-sm-9 col-md-9">
          		<input type="text" value="<%=tut.getQualification()%>" style="width: 100%; border: 1px solid #D5D5D5; border-radius: 0px; padding: 6px 6px 7px; cursor: text; margin: 5px;" >
      ...
      $(function() {
    	    ...
    	    $("#experience").val("<%=tut.getExperience()%>");
    	});
      </script>
           
           <div class="row">
           <div class="form-group">
          	<div class="col-sm-3 col-md-3"> <b style="font-weight: 550;" >Teaching Experience</b></div>
          	

          	<div class="col-sm-9 col-md-9">
          		<input type="number" value="<%=tut.getExperience()%>" style="width: 100%; border: 1px solid #D5D5D5; border-radius: 0px; padding: 6px 6px 7px; cursor: text; margin: 5px;" >

          	</div>

          </div> </div>
          
          <%String[] mode=tut.getTeaching_mode();
     ...
     if(mode!=null)
    	 {for(String mod: mode)
     { if(mod.equals("Home Tuition at Student's Home"))
       { 
    	 %>
    	 <script>
         $(function() {
        	 
       	  $(":checkbox[value='Home Tuition at Student Home']").prop("checked","true");
       	 $("#studenthome").val("Home Tuition at Student's Home");
       	});
         </script> 	  
         <%}
         else{%>
<script>
      $(function() {
    	  $("#studenthome").val("Home Tuition at Student's Home");
    	  $(":checkbox[value='<%=mod%>']").prop("checked","true");
    	});
      </script> 	  
<%     } } }%>   
          ...
          <div class="form-group" >
          	<div class="col-sm-3 col-md-3"> <b style="font-weight: 550;">Teaching Mode</b></div>
          	

          	<div class="col-sm-9 col-md-9">
          		 <div class="checkboxitems" id="teachingmode">
<input class="checkbox" id="studenthome" type="checkbox"  Value = "Home Tuition at Student Home"  name="mode">Home Tuition at Student's Home <br>										
...
<input class="checkbox" type="checkbox"  Value = "Institute or Group Tuition" name="mode">Institute or Group Tuition 
            ...
            <div class="row">
           <div class="form-group">
          	<div class="col-sm-3 col-md-3"> <b style="font-weight: 550;">Expected Fees </b></div>
          	

          	<div class="col-sm-9 col-md-9">
          		<select name="fees" id="fees" required class="required form-control" required >
            ...
            <script>
      $(function() {
    	  $("#<%=tut.getVehicle()%>").prop("checked", true);
            ...
            <div class="form-group">
          	<div class="col-sm-3 col-md-3"> <b style="font-weight: 550;" >Vehicle Owned</b></div>
          	

          	<div class="col-sm-9 col-md-9">
          		<input type="radio" id="Yes" required name="vehicle" value="Yes" class="input-xlarge">Yes
                        <input type="radio" id="No"  name="vehicle" value="No" class="input-xlarge">No

          	</div>

		  </div> </div>
		  <!-- Final style for forms-->
...
<%   while(sub.hasNext()){
    	Subjects subj=sub.next();  
String course=subj.getCourse();
String hide="";
if(course.equals("B.COM/ M.COM"))
	hide="hidebcom";
else if(course.equals("B-Ed"))
	hide="hidebed";
else if(course.equals("B.TECH"))
	hide="hidebtech";
else if(course.equals("BCA-MCA"))
	hide="hidebca";
else if(course.equals("B.M.S"))
	hide="hidebms";
else if(course.equals("BBS"))
	hide="hidebbs";
else if(course.equals("Business Training"))
	hide="hidebusiness";
else if(course.equals("CAT(Common Admission Test)"))
	hide="hidecat";
else if(course.equals("CPT"))
	hide="hidecpt";
else if(course.equals("CA/CS/ICWA"))
	hide="hideca";
else if(course.equals("Class I-V"))
	hide="hideI";
else if(course.equals("Class VI-VIII"))
	hide="hideVI";
else if(course.equals("Class IX-X"))
	hide="hideIX";
else if(course.equals("Class XI-XII"))
	hide="hideXI";
else if(course.equals("Computer/IT"))
	hide="hidecomp";
else if(course.equals("Computer Science Engineering"))
	hide="hidecse";
else if(course.equals("Competitive Exams"))
	hide="hidecompetitive";
else if(course.equals("IIT-JEE"))
	hide="hideenggentrance";
else if(course.equals("Engineering Subjects"))
	hide="hideengg";
else if(course.equals("GRE/GMAT/TOEFL/IELTS"))
	hide="hidegre";
else if(course.equals("Hobby/Creativity"))
	hide="hidehobby";
else if(course.equals("Language"))
	hide="hidelanguage";
else if(course.equals("Laws/Judiciary"))
	hide="hidelaw";
else if(course.equals("M.TECH"))
	hide="hidemtech";
else if(course.equals("Medical Enterance"))
	hide="hidemedical";
else if(course.equals("MBA / BBA"))
	hide="hidemba";
else if(course.equals("Music"))
	hide="hidemusic";
else if(course.equals("Spoken English"))
	hide="hideenglish";
else if(course.equals("Special Educators"))
	hide="hidespecial";
else if(course.equals("Sports Class/Fitness/Yoga"))
	hide="hidesports";
...
<script>
      $(function() {
    	  $(".<%=hide%>").show();
    	  $(":checkbox[value='<%=course%>']").prop("checked","true");
    	});
      </script>
  <%} %>      
		  ...
		  <div class="row" style="margin-bottom: 25px;">
            <div class="form-group">
          	<div class="col-sm-3 col-md-3"> <b style="font-weight: 550;" >Select Courses Preferred</b></div>
          	...
          	<div class="col-sm-9 col-md-9">
					...
					<div class="col-xs-12">
					 <div class="control-group">
						 ...
						 <div class="controls" style="font-weight: 400;">
							 <div class="checkboxitems size-small " id="courses">
	 ...
	 <div class="row" style="margin-bottom: 25px;">
		<div class="form-group">
               ...
               <%  
  Iterator<Subjects> sub1=subjects.iterator();
  while(sub1.hasNext()){
    	Subjects subj=sub1.next();  
if(subj.getSubjects()!=null){
  String[] subjs=subj.getSubjects();
  for(String sj: subjs)
  { 
 	 %>
<script>
   $(function() {
 	  ...
 	  $(":checkbox[value='<%=sj%>']").prop("checked","true");
 	});
   </script> 	  
<%     } } }%>
               
		
		  <div class="col-xs-3"> <b style="font-weight: 550;" >Select Subject Preferred</b></div>
...
<input class="checkbox" type="checkbox"  value="Volley Ball" name="Sports Class/Fitness/Yoga">Volley Ball<br>
	  ...
	  <button class="btn btn-primary nextBtn btn-lg" type="submit">Save Changes</button>
